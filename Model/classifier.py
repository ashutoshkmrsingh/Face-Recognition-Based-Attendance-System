...
class Embedding_and_Training_Classifier:
    def __init__(self, datadir='./Model/student_dir_aligned', \
                 modeldir='./Model/model_facenet/20170511-185253.pb', \
                 classifier_filename='./Model/SVC_classifier/classifier.pkl', output_dir='./Model/SVC_classifier'):
