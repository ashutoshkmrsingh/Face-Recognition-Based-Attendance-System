...
class Align_images:
    def __init__(self, input_datadir='./Model/student_dir_captured', output_datadir='./Model/student_dir_aligned'):
                        ...
                        try:
                            ...
                            if nrof_faces > 0:
                                ...
                                if all(cropped_temp.shape):
                                    ...
                                    print('Invalid Frame', cropped_temp.shape)
                            else:
                                print('Unable to align "%s"' % image_path)
                                text_file.write('%s\n' % (output_filename))
